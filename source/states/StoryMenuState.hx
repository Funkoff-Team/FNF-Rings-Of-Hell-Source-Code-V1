...
import states.StoryModeMenuBFidle;
...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
        ...
        bg.frames = Paths.getSparrowAtlas('menus/EYX/SMMStatic');
		...
		greyBOX = new FlxSprite(0, 0).loadGraphic(Paths.image('menus/EYX/storymenu/greybox'));
		bg.alpha = 1;
		...
		bfIDLELAWL.scale.x = 0.4;
		bfIDLELAWL.scale.y = 0.4;
		...
		portrait = new FlxSprite(450, 79).loadGraphic(Paths.image('menus/EYX/storymenu/MenuArt/bloodnight'));
		...
		staticscreen.frames = Paths.getSparrowAtlas('menus/EYX/storymenu/screenstatic');
		...
		yellowBOX = new FlxSprite(0, 0).loadGraphic(Paths.image('menus/EYX/storymenu/yellowbox'));
		yellowBOX.alpha = 1;
		...
		redBOX = new FlxSprite(0, 0).loadGraphic(Paths.image('menus/EYX/storymenu/redbox'));
		redBOX.alpha = 1;
		...
		sprDifficulty.frames = Paths.getSparrowAtlas('menus/EYX/storymenu/campaign_menu_UI_assets_alt');
		...
		leftArrow.frames = Paths.getSparrowAtlas('menus/EYX/storymenu/campaign_menu_UI_assets');
		...
		rightArrow = new FlxSprite(sprDifficulty.x + 270, sprDifficulty.y);
		rightArrow.frames = Paths.getSparrowAtlas('menus/EYX/storymenu/campaign_menu_UI_assets');
		...
		leftArrow2.frames = Paths.getSparrowAtlas('menus/EYX/storymenu/campaign_menu_UI_assets');
		...
		rightArrow2 = new FlxSprite(860, 136 + 5);
		rightArrow2.frames = Paths.getSparrowAtlas('menus/EYX/storymenu/campaign_menu_UI_assets');
	...
	function changeAct(diff:Int = 1)
	{
		if (FlxG.save.data.storyProgress != 0)
		{
			...
			portrait.loadGraphic(Paths.image('menus/EYX/storymenu/MenuArt/' + songArray[real]));
	...
	function changeSelec()
	{
		...
		if (selection)
		{
			...
			rightArrow.setPosition(865, 145);
		...
		else
		{
			...
			rightArrow.setPosition(550 + 270, 600);
		}
	}
	...
	override public function update(elapsed:Float)
	{
		...
		if (controls.ACCEPT)
		{
			if (oneclickpls)
			{
				...
				if (FlxG.save.data.storyProgress == 0)
				{
					PlayState.storyPlaylist = ['bloodnight'];
